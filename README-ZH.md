...
> **个人笔记**：截图中的演示场景基于舆情分析案例。若想复现相同效果，需在配置文件中将智能体数量设置为 50 以上，并确保 LLM API 的速率限制足够宽松。
>
> **本地运行备注（个人）**：我在本地测试时发现，智能体数量建议从 20 开始逐步增加，避免 API 调用频率过高触发限流。使用 GPT-4o-mini 作为底层模型时，成本相对可控，适合个人学习和实验用途。如果只是想快速跑通流程，10~15 个智能体已经足够看出群体涌现的基本效果。
